...
$templateCache.put("modules/gastank/views/list.html","<div class=\"row\"><div class=\"col-lg-12\"><div class=\"ibox float-e-margins\"><div class=\"ibox-content\"><div class=\"col-md-12\"><div class=\"row\"><div class=\"row\"><div class=\"col-md-5\"><button type=\"button\" ui-sref=\"gastank.insert\" grands-button=\"new\"></button><button type=\"button\" ng-click=\"gastank.methods.delete(selectedValues)\" grands-button=\"delete\" ng-disabled=\"selectedValues.length == 0\"></button></div><div class=\"col-md-7\"><gumga-query search=\"gastank.methods.search(field, param)\" advanced-search=\"gastank.methods.advancedSearch(param)\"><search-field field=\"name\" label=\"Nome\" select=\"true\"></search-field><search-field field=\"number\" label=\"Número\"></search-field><search-field field=\"product.name\" label=\"Produto\"></search-field><advanced-search-field type=\"string\" label=\"Nome\" field=\"name\"></advanced-search-field><advanced-search-field type=\"string\" label=\"Número\" field=\"number\"></advanced-search-field><advanced-search-field type=\"string\" label=\"Produto\" field=\"product.name\"></advanced-search-field></gumga-query></div></div></div></div><div class=\"row\"><div class=\"col-md-12\"><gumga-list data=\"gastank.data\" configuration=\"conf\" class=\"table-bordered\"></gumga-list></div><div class=\"col-md-12\"><ul uib-pagination ng-model=\"gastank.page\" items-per-page=\"gastank.pageSize\" total-items=\"gastank.count\" ng-change=\"gastank.methods.get(gastank.page)\" previous-text=\"<< Anterior\" next-text=\"Próximo >>\" first-text=\"«\" last-text=\"»\"></ul></div></div></div></div></div></div>");}]);
